export const ruTranslations = {
  ...
  marketplacePartner: 'China Town отличный посредник не только в выкупе и карго доставке, но и для вашего бизнеса на маркетплейсах, оставляйте заявку на звонок и убедитесь в этом сами',

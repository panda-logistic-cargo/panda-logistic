export const ruTranslations = {
  ...
  testimonial5Content: 'Сотрудничаем более 2 лет. Особенно радует профессионализм команды и их готовность решать сложные логистиче��кие задачи. Всегда находят оптимальные маршруты доставки.',

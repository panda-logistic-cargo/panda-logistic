export const ruTranslations = {
  ...
  testimonial8Content: 'Panda Logistic стали над����ным партнером в поставках мебели из Китая. Их опыт в организации сборных грузов и работе с крупногабаритными товарами впечатляет.',
  ...
  termsSection1_3: '1.3. Использование сайта подразумевает согласие пользователя с Политикой конфиденциальности, которая является неотъемлемой частью настоящих Условий.',

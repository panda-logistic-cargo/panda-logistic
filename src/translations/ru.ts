export const ruTranslations = {
  ...
  faq3Question: 'Нужно ли страховать груз при доставке из Китая?',
  ...
  storeRatingGrowth: 'Рост рейтинга магазина',
  pandaLogistic: 'Panda Logistic – отличный посредник не только в выкупе и карго доставке, но и для вашего бизнеса на маркетплейсах. Оставляйте заявку на звонок и убедитесь в этом сами.',

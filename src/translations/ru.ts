export const ruTranslations = {
  ...
  privacyPolicySection1_1Title: '1.1. В рамках настоящей Политики под «персональной информацией пользователя» понимаю��ся:',
  ...
  termsSection1_2: '1.2. Настоящие Условия распространяются на всех посети��елей и пользователей сайта.',

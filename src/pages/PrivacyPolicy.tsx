      ...
      <div className="pt-20 pb-16 bg-cargo-gray-100">
        <div className="container mx-auto px-4 mt-10">
          ...
          <article className="prose prose-lg max-w-4xl mx-auto bg-white p-8 rounded-lg shadow-sm">
            ...
            <p className="text-cargo-gray-700 mb-6 text-base font-normal">Настоящая Политика конфиденциальности (далее – Политика) действует в отношении всей информации, которую (далее – Компания), может получить о пользователе во время использования им сайта pandalogist.ru.</p>
            
            <p className="text-cargo-gray-700 mb-8">Использование сайта pandalogist.ru означает безоговорочное согласие пользователя с настоящей Политикой и указанными в ней условиями обработки его персональной информации. В случае несогласия с этими условиями пользователь должен воздержаться от использования сайта.</p>
            ...
            <div className="pl-4">
              ...
              <p className="mb-4">1.2. Настоящая Политика применима только к сайту Компании pandalogist.ru. Компания не контролирует и не несет ответственность за сайты третьих лиц, на которые пользователь может перейти по ссылкам, доступным на сайте.</p>

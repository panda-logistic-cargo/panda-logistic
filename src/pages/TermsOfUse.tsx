        ...
        <div className="container mx-auto px-4 mt-10">
          ...
          <article className="prose prose-lg max-w-4xl mx-auto">
            ...
            <p className="text-cargo-gray-700 mb-6">
              Настоящие Условия использования (далее – Условия) регулируют порядок использования сайта www.cargo-a71.ru, принадлежащего (далее – Компания). Использование сайта означает безоговорочное согласие пользователя с настоящими Условиями.
            </p>

            <h2 className="text-2xl font-bold mt-8 mb-4">1. Общие положения</h2>
            <div className="pl-4">
              <p className="mb-4">1.1. Сайт www.cargo-a71.ru предназначен для предоставления информации о деятельности, включая услуги по поиску поставщиков, выкупу с маркетплейсов, консолидации грузов а также для обработки запросов пользователей.</p>

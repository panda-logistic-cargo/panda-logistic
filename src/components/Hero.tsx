      ...
      <div className="container relative z-10 mx-auto px-4 pt-20">
        <div className="max-w-3xl">
          <div className="inline-block mb-4 px-4 py-1 bg-cargo-red/10 backdrop-blur-sm rounded-full border border-cargo-red/20">
            <span className="text-white font-medium">Panda Logistics</span>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <Link to="/calculator">
              <Button size="lg" className="bg-cargo-red hover:bg-cargo-red/90 text-white font-medium rounded-md w-full sm:w-auto">
            ...
            <Link to="/contacts">
              <Button variant="outline" size="lg" className="bg-white/10 backdrop-blur-sm border-white/20 text-white hover:bg-white/20 hover:text-white rounded-md w-full sm:w-auto">
                {t('contactUs')}

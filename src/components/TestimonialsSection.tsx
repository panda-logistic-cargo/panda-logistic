...
const TestimonialsSection: React.FC = () => {
  ...
  const testimonials = [
    ...
    },
    {
      ...
      content: "Благодарны команде Cargo A71 за помощь в организации поставок косметики. Их знание специфики работы с китайскими производителями сэкономило нам много времени и ресурсов.",
      rating: 5
    },
    {
      name: "Игорь Соколов",
    ...
    },
    {
      ...
      content: "Cargo A71 стали надежным партнером в поставках мебели из Китая. Их опыт в организации сборных грузов и работе с крупногабаритными товарами впечатляет.",
      rating: 5
    },
    {
      name: "Сергей Новиков",

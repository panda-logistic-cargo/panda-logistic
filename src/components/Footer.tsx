...
const Footer: React.FC = () => {
  ...
  const serviceLinks = [{
    name: t('supplierSearch'),
    href: '/services/supplier-search'
  }, {
    name: t('marketplacePurchase'),
    href: '/services/marketplace-purchase'
  }, {
    name: t('cargoConsolidation'),
    href: '/services/cargo-consolidation'
  }, {
    name: t('delivery'),
    href: '/services/delivery'
  }, {
    name: t('businessTours'),
      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          ...
          <div>
            ...
            <p className="text-cargo-gray-300 mb-4">Международная логистическая компания с многолетним опытом доставки грузов из Китая в Россию.</p>
